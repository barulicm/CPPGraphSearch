...
/**
 * @brief Runs Depth-First Search on the problem described by the function arguments
...
DFS(const StateType &startState, std::function<bool(const StateType &)> isGoal,
